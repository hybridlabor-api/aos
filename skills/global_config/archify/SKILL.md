...
metadata:
  version: "2.17"
  author: tt-a1i
  origin: tt-a1i/archify@9e35d2b
  based_on: Cocoon-AI/architecture-diagram-generator (MIT, v1.0)
---

<!-- Source: tt-a1i/archify archify/ — MIT, see THIRD_PARTY_NOTICES.md -->
...
This copy ships with AOS, which pins its version; the upstream update check
was removed. `node bin/archify.mjs` below also runs as `aos-archify` from any
directory. In an AOS pipeline the Architect renders the plan's architecture to
`production_artifacts/00_architecture.html`, which is reviewed in plan-canvas
and linked from the live map via the component's `url:` line.
