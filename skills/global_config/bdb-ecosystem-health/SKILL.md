...
- [ ] HTML report generated and verifiable at `production_artifacts/ecosystem_health_latest.html`.
...
```bash
scripts/ecosystem-health-audit.js
```

### Script Output:
* **HTML Dashboard**: `production_artifacts/ecosystem_health_latest.html`
